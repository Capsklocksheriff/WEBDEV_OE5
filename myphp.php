...
if(isset($_POST ['button'])){
    if($dbc){
        ...
        $input_studentID = $_REQUEST['input6_ID'];
        ...
        $query = "INSERT INTO users_tbl(firstName, lastname, birthdate,email,address,password,regs_date) VALUES ('$input_fName','$input_lName','$input_birthDay','$input_email','$input_address','$input_password',NOW())";
